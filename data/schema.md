...
- an explicit heatDisplay record with dynamic frame count, ordered time-step multipliers, exact frame times, and pathSolveUsesDisplayFrames set to false;
...
- Genus 3: rounded-triangle-rosette;
- Genus 4: rounded-diamond-rosette;
- Genus 5: five-point-rosette.
